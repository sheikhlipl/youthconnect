...
public class QAPublishedActivity extends BaseActivity implements
    ...
    public void onEditQuestionClick(final Document qaDoc) {
        ...
        LayoutInflater li = LayoutInflater.from(QAPublishedActivity.this);
        View promptsView = li.inflate(R.layout.alert_dialog_with_input_text, null);

        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                QAPublishedActivity.this);
    ...
    public void onAnswerClick(final Document qaDoc) {
        String description = (String) qaDoc.getProperty(BuildConfigYouthConnect.QA_DESC);
        LayoutInflater li1 = LayoutInflater.from(QAPublishedActivity.this);
    ...
    public void onPublishClick(final Document _qaDoc) {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QAPublishedActivity.this,
                R.style.AppCompatAlertDialogStyle);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(QAPublishedActivity.this, QAPublishedActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        finish();
